...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsTodoApp = __webpack_require__(178);

	var _jsTodoApp2 = _interopRequireDefault(_jsTodoApp);

	var _jsReducers = __webpack_require__(184);

	var _jsReducers2 = _interopRequireDefault(_jsReducers);

	var store = (0, _redux.createStore)(_jsReducers2['default']);

	var rootElement = document.getElementById("todo");
	(0, _reactDom.render)(_react2['default'].createElement(
	  _reactRedux.Provider,
	  { store: store },
	  _react2['default'].createElement(_jsTodoApp2['default'], null)
	), rootElement);
